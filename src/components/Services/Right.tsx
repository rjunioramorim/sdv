...
export default function ServiceLeft(props) {
  ...
  return (
    <>
      <div className="flex flex-col md:flex-row transform transition-all duration-200 ease-in-out justify-between items-center container mx-auto text-gray-700 px-6 pb-6">
